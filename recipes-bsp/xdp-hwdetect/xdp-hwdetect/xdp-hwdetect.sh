...
ID=`i2cget -f -y 5 5e 0 2>/dev/null`
if [ "${ID}" = "0x44" ]
then
...
#MIPI CSI2-Rx Subsystem
media-ctl -d /dev/media0 -V "\"a0110000.csiss\":1  [fmt:SRGGB10_1X10/1920x1080 field:none]"
media-ctl -d /dev/media0 -V "\"a0110000.csiss\":0  [fmt:SRGGB8_1X8/1920x1080 field:none]"
#Demosaic IP
media-ctl -d /dev/media0 -V "\"a0160000.demosaic\":0  [fmt:SRGGB8_1X8/1920x1080 field:none]"
media-ctl -d /dev/media0 -V "\"a0160000.demosaic\":1  [fmt:RBG888_1X24/1920x1080 field:none]"

media-ctl -d /dev/media0 -V "\"a0120000.v_proc_ss\":0  [fmt:RBG888_1X24/1920x1080 field:none]"
media-ctl -d /dev/media0 -V "\"a0120000.v_proc_ss\":1  [fmt:RBG888_1X24/1920x1080 field:none]"
